...
DEFAULT_WIKI_CHARACTERS = Path(r"D:\magia\MyProducts\magireco-wiki-data\data\characters.json")
DEFAULT_WIKI_MEMORIA = Path(r"D:\magia\MyProducts\magireco-wiki-data\data\memoria.json")
