...
const audit=JSON.parse(fs.readFileSync(path.join(__dirname,'../magica/i18n_audit/existing_text_review_20260923/batch07-corrections.json'),'utf8'));
...
// Previously accepted names and state distinctions remain untouched.
