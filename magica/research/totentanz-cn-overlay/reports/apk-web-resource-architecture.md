...
**两套 ZIP 并不是“一个 APK 本地体系、一个网络 `magica` 体系”。**它们都是从同一版 `legacy-client` APK/反编译仓库提取出的同一批资源，只是交付形态不同：
...
| 当前 `patch-front/magica/` | CSS/HTML/JS/JSON、11 个 Web PNG 和 1 个字体；发布时打成 `cn_js_update.zip` | 不是上述 ZIP 的第二种呈现 | 是，但下载后又由本地 WebView 覆盖层提供 |
...
| 仓库 | 提交 |
|---|---|
| `MagirecoCN-Revival-Project/legacy-client` | `8f6dba66ccf2d526a6ea2a60e73491af7d18b05f` |
| `HiiragiNemu/patch-front` | `3c983a778429d5e56a2569aa28ea8c622d988c63` |
